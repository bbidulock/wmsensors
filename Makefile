...
# operating system:  Linux 2.4.9-ac17 i686 [ELF] (2.4.9)
# libc:	(6.2.4)
# binutils:	(31)
...
all:: wmsensors.$(MANNEWSUFFIX)

wmsensors.$(MANNEWSUFFIX): wmsensors.$(MANSRCSUFFIX)
	$(RM) $@
	$(LN) wmsensors.$(MANSRCSUFFIX) $@

cleandir::
	$(RM) wmsensors.$(MANNEWSUFFIX)

install.man:: wmsensors.$(MANNEWSUFFIX)
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) wmsensors.$(MANNEWSUFFIX) $(DESTDIR)$(MANDIR)/wmsensors.$(MANSUFFIX)
